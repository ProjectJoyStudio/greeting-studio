...
const K: Record<string, Row> = {
  ...
  admin_role_editor: { en: "Editor", ru: "Редактор", de: "Redakteur", uk: "Редактор", fr: "Éditeur", pl: "Redaktor" },
  admin_role_customer: { en: "Customer", ru: "Клиент", de: "Kunde", uk: "Клієнт", fr: "Client", pl: "Klient" },
  ...
  admin_enable_gate_body: {
    en: "Access to the Admin Panel is restricted and uses your real account permissions.",
    ru: "Доступ к админ-панели ограничен и зависит от реальных прав вашего аккаунта.",
    de: "Der Zugriff auf das Admin-Panel ist eingeschränkt und nutzt deine echten Kontorechte.",
    uk: "Доступ до адмін-панелі обмежено й залежить від реальних прав вашого акаунта.",
    fr: "L'accès au panneau d'administration est restreint et utilise les autorisations réelles de votre compte.",
    pl: "Dostęp do panelu administratora jest ograniczony i korzysta z rzeczywistych uprawnień konta.",
  },
  admin_gate_loading: { en: "Checking permissions…", ru: "Проверяем права…", de: "Berechtigungen werden geprüft…", uk: "Перевіряємо права…", fr: "Vérification des autorisations…", pl: "Sprawdzanie uprawnień…" },
  admin_gate_signed_out: { en: "Sign in with an authorized account to continue.", ru: "Войдите в аккаунт с нужными правами, чтобы продолжить.", de: "Melde dich mit einem berechtigten Konto an, um fortzufahren.", uk: "Увійдіть в акаунт із потрібними правами, щоб продовжити.", fr: "Connectez-vous avec un compte autorisé pour continuer.", pl: "Zaloguj się na konto z odpowiednimi uprawnieniami, aby kontynuować." },
  admin_gate_denied: { en: "This account does not have catalog administration permissions.", ru: "У этого аккаунта нет прав на управление каталогом.", de: "Dieses Konto hat keine Berechtigung zur Katalogverwaltung.", uk: "Цей акаунт не має прав на керування каталогом.", fr: "Ce compte ne dispose pas des autorisations d'administration du catalogue.", pl: "To konto nie ma uprawnień do zarządzania katalogiem." },
  admin_refresh_permissions: { en: "Refresh permissions", ru: "Обновить права", de: "Berechtigungen aktualisieren", uk: "Оновити права", fr: "Actualiser les autorisations", pl: "Odśwież uprawnienia" },
  admin_sign_in: { en: "Sign in", ru: "Войти", de: "Anmelden", uk: "Увійти", fr: "Se connecter", pl: "Zaloguj się" },
  ...
  admin_nav_dev_credits: { en: "Bonus Credits", ru: "Бонусные кредиты", de: "Bonus-Credits", uk: "Бонусні кредити", fr: "Crédits bonus", pl: "Kredyty bonusowe" },
  admin_nav_your_credits: { en: "Your Credits", ru: "Ваши кредиты", de: "Deine Credits", uk: "Ваші кредити", fr: "Vos crédits", pl: "Twoje kredyty" },
