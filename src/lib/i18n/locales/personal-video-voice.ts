...
export const PERSONAL_VIDEO_VOICE_I18N: Record<Lang, Dict> = {
  en: {
    ...
    pvv_voiceover: "Voice of the greeting",
    pvv_voiceover_hint: "No person was added, so the greeting is heard as a voice-over. Choose the voice below.",
  ...
  ru: {
    ...
    pvv_voiceover: "Голос поздравления",
    pvv_voiceover_hint: "Человек не добавлен, поэтому поздравление звучит закадровым голосом. Выберите голос ниже.",
  ...
  de: {
    ...
    pvv_voiceover: "Stimme des Grußes",
    pvv_voiceover_hint: "Es wurde keine Person hinzugefügt, der Gruß erklingt daher als Off-Stimme. Wählen Sie unten die Stimme.",
  ...
  uk: {
    ...
    pvv_voiceover: "Голос привітання",
    pvv_voiceover_hint: "Людину не додано, тому привітання лунає закадровим голосом. Оберіть голос нижче.",
  ...
  fr: {
    ...
    pvv_voiceover: "Voix des vœux",
    pvv_voiceover_hint: "Aucune personne n'a été ajoutée : les vœux sont dits en voix off. Choisissez la voix ci-dessous.",
  ...
  pl: {
    ...
    pvv_voiceover: "Głos życzeń",
    pvv_voiceover_hint: "Nie dodano osoby, więc życzenia zabrzmią jako narracja. Wybierz głos poniżej.",
