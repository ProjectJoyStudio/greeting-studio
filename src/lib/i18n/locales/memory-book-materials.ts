...
export const MEMORY_BOOK_MATERIALS_I18N: Record<Lang, Dict> = {
  en: {
    ...
    mbm_video_uploading: "Video is uploading…",
    mbm_video_failed: "The video could not be uploaded. Please try again.",
    mbm_remove: "Remove",
  ...
  ru: {
    ...
    mbm_video_uploading: "Видео загружается…",
    mbm_video_failed: "Не удалось загрузить видео. Попробуйте ещё раз.",
    mbm_remove: "Удалить",
  ...
  uk: {
    ...
    mbm_video_uploading: "Відео завантажується…",
    mbm_video_failed: "Не вдалося завантажити відео. Спробуйте ще раз.",
    mbm_remove: "Видалити",
  ...
  pl: {
    ...
    mbm_video_uploading: "Trwa przesyłanie filmu…",
    mbm_video_failed: "Nie udało się przesłać filmu. Spróbuj ponownie.",
    mbm_remove: "Usuń",
  ...
  de: {
    ...
    mbm_video_uploading: "Video wird hochgeladen…",
    mbm_video_failed: "Das Video konnte nicht hochgeladen werden. Bitte erneut versuchen.",
  ...
  fr: {
    ...
    mbm_video_uploading: "La vidéo est en cours de téléversement…",
    mbm_video_failed: "La vidéo n'a pas pu être téléversée. Veuillez réessayer.",
